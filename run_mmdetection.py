...
def infer_video(file, detection_threshold, detector):
    video_in = cv2.VideoCapture(f'dataset/videos/{file}')
...
if __name__ == '__main__':
    ...
    detector = {
        ...
        'engine': MMDetectionDetector(
            ...
            'configs/faster_rcnn_crowdhuman_carta.py',
            'work_dirs/faster_rcnn_crowdhuman_carta/epoch_12.pth',
            'head'
        ),
        'color': (255, 0, 0)
    }
