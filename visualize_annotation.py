...
base_path = 'crowdhuman/'
annotation_coco = util.file_handler.load_json(base_path + 'annotation_train.json')
...
for i in range(100):
    ...
    path = base_path + 'images_train/' + annotation_coco['images'][image_number_to_display]['file_name']
    print(path)
    img = cv2.imread(path)
